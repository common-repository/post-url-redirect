...
final class Pur_Redirector {
	...
	public function __construct()
	{
		...
		add_action( 'template_redirect', array( $this, 'Pur_template_redirect_url' ) );
		add_action( 'cachify_skip_cache', array( $this, 'Pur_cachify' ) ); // compability for cachify
	 ...
	 **/
	public function Pur_template_redirect_url()
	{
